...
export default function Footer() {
  return (
    <footer className="py-12 bg-bg-surface border-t border-accent-primary/20">
      <div className="container mx-auto px-6">
        ...
        <motion.div
          className="mt-8 pt-8 border-t border-accent-primary/10 text-center text-text-muted text-sm"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, amount: 0.5 }}
          variants={fadeInUp}
          custom={1}
        >
          <p>© {new Date().getFullYear()} Web3 Guestbook. All messages are stored permanently on the Ethereum blockchain.</p>
        </motion.div>
      </div>
    </footer>
  );
